...
Status: ✅ **live** — verified 2026-08-11 (DOM scan + console spy), both A/B variants (`augiA20Il` / `J4y1ztAFM`).
...
| 3 | `product` | product carousel cards + hero "See X" buttons | product slider (B: + hero carousel) | See Epoc X, See Insight, See MN8, See Flex 2 | `cta_click` | 16 / 20 |
