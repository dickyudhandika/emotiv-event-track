...
|---|---|---|---|---|---|---|
| 1 | `nav` | global navigation | header | Shop Now, Start Now | `cta_click` | ✅ live |
| 2 | `hero` | first fold | hero | User & Product Research, Academic Research | `cta_click` | ✅ live |
| 3 | `product` | product slideshow cards | product slider | See Epoc X, See Insight, See MN8, See Flex 2 | `cta_click` — NO `product` prop (rev-2: homepage intentionally un-nested) | ✅ live |
| 4 | `applications` | use-case accordion cards | "Versatile by design" | Access Research Hub, Start Building | `cta_click` | ✅ live (shared comp → all 4 buttons) |
| 5 | `pathway` | audience selector cards | pathway section | Play Now, Start Building | `cta_click` | ✅ live |
| 6 | `platform` | platform pitch CTA | "Operating System for the Brain" | Start Building | `cta_click` | ✅ live |
| 7 | `news` | article cards | latest news | article titles, Read latest news | `content_click` | ✅ live |
| 8 | `footer` | footer band CTAs | footer | User & Product Research, Academic Research | `cta_click` | ✅ live |
| 9 | `footernav` | footer link columns | footer | Academic Research, Epoc X, KB | `content_click` | ✅ live |
| 10 | `footer` (newsletter) | subscribe form | footer | Subscribe here | `form_submit` | ✅ live |
